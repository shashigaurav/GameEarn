...
// project intentionally has no client-side JS build pipeline. Used by the admin
// panel (js/admin/*) and by js/search-live.js for live public game search.
...
export function configWarningHtml() {
  return `<div class="config-warning">
    <strong>Supabase isn't configured yet.</strong> Set <code>VITE_SUPABASE_URL</code> and
    <code>VITE_SUPABASE_ANON_KEY</code> in your Vercel project's Environment Variables (see the
