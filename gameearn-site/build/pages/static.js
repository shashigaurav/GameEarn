...
function aboutPage() {
  return simplePage(
    ...
    `<p>GameEarn is a discovery platform built for one purpose: helping players find gaming and reward apps worth their time. Instead of hosting games ourselves, we organize information about them — category, platform, reward type, ratings and features — so you can compare options before visiting an app's official page.</p>
    <h2>What we do</h2>
    <p>We list and describe games and reward apps across genres, from classic action and puzzle titles to apps built around points, gift cards and tournament rewards. Every listing links out to the developer's own official source for downloads and up-to-date terms.</p>
    <h2>What we don't do</h2>
    <ul>
      <li>We do not host or distribute installation files (APKs or otherwise).</li>
      <li>We do not process payments, wallets or withdrawals.</li>
      <li>We do not guarantee earnings, payouts or rankings for any listed app.</li>
      <li>We do not control the reward programs described on game pages — those are run entirely by each app's own provider.</li>
    </ul>
    <p>If something on a game page looks out of date, <a href="/contact/">let us know</a>.</p>`
  );
}
...
function termsPage() {
  return simplePage(
    ...
    <p>GameEarn is an informational discovery platform for gaming and reward apps. We do not develop, publish, host or distribute the games and apps listed, and we do not control their reward programs, eligibility rules or payout terms.</p>
    <h2>No guarantee of earnings</h2>
    <p>Any mention of rewards, points, gift cards, cashback or tournament prizes on this site is descriptive only. GameEarn does not guarantee that any user will earn, receive or be eligible for any reward from any listed app. Reward availability varies by app, region and eligibility, and is determined solely by that app's provider.</p>
    <h2>Third-party sources</h2>
    <p>"Visit Official Source" links direct you to the developer's own website or store listing. GameEarn is not responsible for the content, accuracy, security or terms of third-party sites.</p>
...
function disclaimerPage() {
  return simplePage(
    ...
    `<p>GameEarn is an independent discovery and information platform for gaming and reward apps.</p>
    <ul>
      <li>We are not affiliated with the games or apps listed unless explicitly stated.</li>
      <li>We do not guarantee any level of earnings, payouts or rewards from any listed app.</li>
      <li>Reward availability varies by app, region and eligibility, and is controlled entirely by each app's own provider and its official terms.</li>
      <li>We do not host, distribute or verify installation files (including APKs) for any listed app.</li>
      <li>Ratings, screenshots and descriptions shown on this site are for informational purposes and may not reflect the current state of an app after updates.</li>
      <li>Always review an app's official terms, privacy policy and permissions before downloading or participating in any rewards program.</li>
    </ul>
