...
<section class="page-head">
  <div class="container">
    ...
    <p class="page-intro">Rewards come in a few different forms depending on the game or offer. Here's what each type means, plus quick links to your dashboard and history.</p>
  </div>
</section>
<section class="section" style="padding-top:0;">
  <div class="container">
    <div class="grid">
      ...
      ${trustCard('<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="8" cy="8" r="3"/><circle cx="17" cy="10" r="2.4"/><path d="M2.5 20c0-3.3 2.5-6 5.5-6s5.5 2.7 5.5 6"/></svg>', "Referral Rewards", "A bonus for you (and often your friend) once they complete their first verified offer.")}
    </div>
    ...
    <div class="cta-banner glass" style="margin-top:36px;">
      <h2>Track your own rewards</h2>
      <p>See your live totals, daily streak and completed offers in one place.</p>
      <div class="hero-actions">
        <a href="/dashboard/" class="btn btn-primary">Open Dashboard</a>
        <a href="/rewards/history/" class="btn btn-outline-blue">View Rewards History</a>
      </div>
    </div>
  </div>
</section>
