...
<section class="section" style="padding-top:0;">
  <div class="container">
    ${demoBanner("Demo profile — sign in to see your real account details.")}
    ...
    <div class="profile-menu">
      ...
      <button class="glass" onclick="alert('Logout requires a connected backend — this is a demo profile.');">Logout <span>&rarr;</span></button>
    </div>
  </div>
</section>
`;
